...
# Form implementation generated from reading ui file 'D:\\PyCharmProjects\\Dicom_database\\ui\\image_url.ui'
#
...
"}"))
        ...
        self.info_label.setGeometry(QtCore.QRect(10, 10, 251, 21))
        ...
        self.choose_button = QtGui.QPushButton(self.centralwidget)
        self.choose_button.setGeometry(QtCore.QRect(20, 90, 93, 28))
        self.choose_button.setStyleSheet(_fromUtf8("#choose_button{ background-color : darkBlue;color : white; }"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.info_label.setText(_translate("MainWindow", "Choose a dir where DCM image is stored", None))
        self.choose_button.setText(_translate("MainWindow", "Choose", None))
